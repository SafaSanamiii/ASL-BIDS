...
%% variables
spatSigma=4%7; % smoothing in mm (isotropic)
labelIDs=[0 1]; % unlabeled/labeled IDs in label input
doPlot=1; % plot images
...
%gm=dip_array(threshold(cbf)); % GM-mask
cbf_nonzero = cbf;
cbf_nonzero(cbf_nonzero<0) = 0;
gm = xASL_im_IsoDataThreshold(cbf_nonzero);
